...
from models.layers.attentions import DeformableEnhancedSpatialAttention


class DESADensenetEncoder(nn.Module):
    def __init__(self, enc_model, cls_num):
        ...
        self.desa_module_0 = DeformableEnhancedSpatialAttention(64, 4)

        self.dense_block_1 = encoder.features.denseblock1
        self.desa_module_1 = DeformableEnhancedSpatialAttention(256, 4)
        self.transition_1 = encoder.features.transition1

        self.dense_block_2 = encoder.features.denseblock2
        self.desa_module_2 = DeformableEnhancedSpatialAttention(512, 4)
...
if __name__ == '__main__':
    ...
    model = DESADensenetEncoder('densenet121', 2).cuda()
