...
from models.layers.attentions import EnhancedSpatialAttention


class ESADensenetEncoder(nn.Module):
    def __init__(self, enc_model, cls_num):
        ...
        self.esa_module_0 = EnhancedSpatialAttention(64, 4)

        self.dense_block_1 = encoder.features.denseblock1
        self.esa_module_1 = EnhancedSpatialAttention(256, 4)
        self.transition_1 = encoder.features.transition1

        self.dense_block_2 = encoder.features.denseblock2
        self.esa_module_2 = EnhancedSpatialAttention(512, 4)
