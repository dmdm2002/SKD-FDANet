...
from models.layers.attentions import FrequencyDeformableAttention
...
class FDADensenetEncoder(nn.Module):
    def __init__(self, enc_model, cls_num):
        ...
        self.fdesa_module_0 = FrequencyDeformableAttention(64, 4)

        self.dense_block_1 = encoder.features.denseblock1
        self.fdesa_module_1 = FrequencyDeformableAttention(256, 4)
        self.transition_1 = encoder.features.transition1

        self.dense_block_2 = encoder.features.denseblock2
        self.fdesa_module_2 = FrequencyDeformableAttention(512, 4)
